...
// Log each variable's value and its type to the console using console.log() and typeof
console.log("Employee Is Active:", isActive, "-", typeof isActive);
...
// Log each variable's value and its type to the console.
console.log("Product Is Available:", isAvailable, "-", typeof isAvailable);
...
// Division
accountBalance /= 2
console.log("Account Balance After Taking Out Half: $", accountBalance)
...
let customerName = "London Brown";

// Concatenate strings to form a welcome message and log it to the console
let welcomeMessage = "We are pleased to welcome you " + customerName + ", thank you for choosing us!";
